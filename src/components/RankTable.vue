<template>
    <div class="border-2 border-b-0 dark:text-white dark:border-gray-800">
        <div class="inline-flex gap-4 items-center bg-zinc-200 select-none dark:bg-zinc-700">
